...
|07|[계단](#team-07)| 유북 : 간편하게 자서전을 만들고 싶은 일반인들을 위해 사용자가 직접 입력한 내용을 기반으로 생성형 ai 기술을 활용해 자서전을 만들어주는 웹서비스
...
# Team-07
| (1) 과제명 | 유북 : 간편하게 자서전을 만들고 싶은 일반인들을 위해 사용자가 직접 입력한 내용을 기반으로 생성형 ai 기술을 활용해 자서전을 만들어주는 웹서비스
|:---  |---  |
| (2) 팀 번호 / 팀 이름 | 07-계단 |
...
| (7) 과제 내용 요약 | 간편하게 자서전을 만들고 싶은 일반인들을 위해 사용자가 직접 입력한 내용을 기반으로 생성형 ai 기술을 활용해 자서전을 만들어주는 웹서비스 |
| (10) 기타 |  |
